    ...
    public class ShoppingCart
    {
        ...
        public void AddToCart(Pizza pizza, int amount)
        {
            var shoppingCartItem = _appDbContext.ShoppingCartItem
                .SingleOrDefault(s => s.Pizza.PizzaId == pizza.PizzaId && s.ShoppingCartId == ShoppingCartId);
        ...
        public List<ShoppingCartItem> GetShoppingCartItems()
        {
            return ShoppingCartItems ?? 
                (ShoppingCartItems = _appDbContext.ShoppingCartItem.Where(c => c.ShoppingCartId == ShoppingCartId)
                    .Include(s => s.Pizza)
                    .ToList());
        }
